<style type="text/css">
	...
	#Tab_1 .Tab_Title_2{color:#ffc937;top:270px;left:0;}
	...
	<div id="Tab_Wrap">
		<div class="Tab" id="Tab_1">
			<div class="Tab_Contents">
				...
				<div data-aniinx="2" class="Tab_Title_2">Help is Helper<i>!</i></div>
				<div data-aniinx="3" class="Tab_Desc"><?php echo $this->_Lang_helper_home['s1_desc'];?></div>
				<a href="/add" class="Tab_Register_BTN"><?php echo $this->_Lang_helper_home['create_card'];?></a>
				<div data-aniinx="4" class="Tab_Img"><img src="/Template/Img/Home-PG5-bg.png" /></div>
			</div>
