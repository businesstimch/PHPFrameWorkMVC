<style type="text/css">
	...
	.SplineGraph{width:100%;height:300px;margin-bottom:10px;}
	...
	var createCharts = new function(){
		...
		var drawChart = function(Data){
			...
			$.ajax({
				type: "POST",
				url: "?ajaxProcess",
				data: "menu=getChartData&DateFrom="+Data['DateFrom']+"&DateTo="+Data['DateTo'],
				success: function(d){
					...
					if(res.ack == 'success')
					{
						...
						createDateRangeSaleGraph('InternetNew_Graph','Internet New',res.InternetNew);
						createDateRangeSaleGraph('InternetOld_Graph','Internet Old',res.InternetOld);
						createDateRangeSaleGraph('WalkNew_Graph','Walk-In New',res.WalkNew);
						createDateRangeSaleGraph('WalkOld_Graph','Walk-In Old',res.WalkOld);
...
<h2 id="PG_Title">
	<div><i class="fa fa-folder-o"></i> Visitors Flow Reports <span id="DateRangeTop"></span></div>
...
<div id="PG_Contents">
	...
	<div class="w100 hidePrint" id="topSummaryBlock" data-targetprintid="0">
		...
		<div id="InternetNew_Graph" class="SplineGraph"></div>
		<div id="InternetOld_Graph" class="SplineGraph"></div>
		<div id="WalkNew_Graph" class="SplineGraph"></div>
		<div id="WalkOld_Graph" class="SplineGraph"></div>
