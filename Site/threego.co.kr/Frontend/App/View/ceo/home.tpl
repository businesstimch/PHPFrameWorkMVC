<style type="text/css">
	...
	#Tab_1 .Tab_Img{right:0;background-image:url('/Template/Img/CeoHome-PG1-bg.png');}
	
	#Tab_2 .Tab_BG{background-color:white;width:100%;height:100%;}
	#Tab_2 .Tab_Number{border:1px solid black;top:65px;right:0;}
	#Tab_2 .Tab_Title_1{color:#2f2f2f;top:173px;right:0;}
	#Tab_2 .Tab_Title_2{color:#00a3e8;top:270px;right:0;}
	#Tab_2 .Tab_Register_BTN{top:480px;right:0}
	#Tab_2 .Tab_Desc{top:391px;right:0;color:#575757;}
	#Tab_2 .Tab_Img{left:0;background-image:url('/Template/Img/CeoHome-PG2-bg.png');}
	
	#Tab_3 .Tab_BG{background-color:white;width:100%;height:100%;}
	#Tab_3 .Tab_Number{border:1px solid black;top:65px;left:0;}
	#Tab_3 .Tab_Title_1{color:#2f2f2f;top:173px;left:0;}
	#Tab_3 .Tab_Title_2{color:#00a3e8;top:270px;left:0;}
	#Tab_3 .Tab_Register_BTN{top:480px;}
	#Tab_3 .Tab_Desc{top:391px;left:0;color:#575757;}
	#Tab_3 .Tab_Img{right:0;background-image:url('/Template/Img/CeoHome-PG3-bg.png');}
	...
	<div id="Tab_Wrap">
		<div class="Tab" id="Tab_1">
			<div class="Tab_Contents">
				...
				<div data-aniinx="1" class="Tab_Title_1"><?php echo $this->_Lang_ceo_home['s1_title_1'];?></div>
				<div data-aniinx="2" class="Tab_Title_2"><?php echo $this->_Lang_ceo_home['s1_title_2'];?><i>!</i></div>
				<div data-aniinx="3" class="Tab_Desc"><?php echo $this->_Lang_ceo_home['s1_desc'];?></div>
				<a href="/add" class="Tab_Register_BTN"><?php echo $this->_Lang_ceo_home['create_business_card'];?></a>
		...
		<div class="Tab" id="Tab_2">
			<div class="Tab_Contents">
				...
				<div data-aniinx="1" class="Tab_Title_1"><?php echo $this->_Lang_ceo_home['s2_title_1'];?></div>
				<div data-aniinx="2" class="Tab_Title_2"><?php echo $this->_Lang_ceo_home['s2_title_2'];?><i>!</i></div>
				<div data-aniinx="3" class="Tab_Desc"><?php echo $this->_Lang_ceo_home['s2_desc'];?></div>
				<a href="/add" class="Tab_Register_BTN"><?php echo $this->_Lang_ceo_home['create_business_card'];?></a>
				<div data-aniinx="4" class="Tab_Img"></div>
			</div>
			<div class="Tab_BG"></div>
		...
		<div class="Tab" id="Tab_3">
			<div class="Tab_Contents">
				...
				<div data-aniinx="1" class="Tab_Title_1"><?php echo $this->_Lang_ceo_home['s3_title_1'];?></div>
				<div data-aniinx="2" class="Tab_Title_2"><?php echo $this->_Lang_ceo_home['s3_title_2'];?><i>!</i></div>
				<div data-aniinx="3" class="Tab_Desc"><?php echo $this->_Lang_ceo_home['s3_desc'];?></div>
				<a href="/add" class="Tab_Register_BTN"><?php echo $this->_Lang_ceo_home['create_business_card'];?></a>
				<div data-aniinx="4" class="Tab_Img"></div>
			</div>
			<div class="Tab_BG"></div>
