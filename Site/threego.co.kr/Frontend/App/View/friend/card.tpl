			...
			if(isset($Cards['C']))
			{
				...
				foreach($Cards['C'] AS $Cards_F)
				{
					echo '
						...
						<div class="Card_Pic Card_Pic_Main Glow C_Comon">'.(isset($Cards_F['CardPics']) && sizeof($Cards_F['CardPics']) > 0 ? '<img src="/Template/Img/CData/'.$this->login->customers_id.'/F/'.$Cards_F['Card_ID'].'/CardImg/'.$Cards_F['CardPics'][0].'" />' : '사진').'</div>
